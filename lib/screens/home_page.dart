...
import '../helpers/add_favorites.dart';
...
class _HomePageState extends State<HomePage> {
  final helperFunction = AddFavorites();
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          if (!helperFunction.favorites
                              .contains(products[index])) {
                            helperFunction.addToFavorites(products[index]);
                          } else {
                        ...
                        child:
                            helperFunction.favorites.contains(products[index])
